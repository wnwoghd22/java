...
public class Level3 {
	public static void main(String[] args) {
		...
		try {
			String input = "Complex.txt", output = "ComplexP.txt";
			...
			while(sc.hasNextLine()) {
				...
				try {
					...
					case 5 : //circle	
						...
						if(!Geo.isCircle(cArr)) fw.write("(" + cArr[0] + ", " + cArr[1] + "), (" + cArr[2] + ", " + cArr[3] + ") is not a circle.\n");
						if(Geo.isCircleC(cArr)) {
						list.add(new Circle(
					...
					case 7 : //triangle
						...
						if(!Geo.isTriangle(tArr))  fw.write("(" + tArr[0] + ", " + tArr[1] + "), (" + tArr[2] + ", " + tArr[3] + "), ("+ tArr[4] + ", " + tArr[5] + ") is not a triangle.\n");
						if(Geo.isTriangleC(tArr)) {
					...
					case 9 : //quadrangle
						...
						if(!Geo.isQuadrangle(qArr)) fw.write("(" + qArr[0] + ", " + qArr[1] + "), (" + qArr[2] + ", " + qArr[3] + "), ("+ qArr[4] + ", " + qArr[5] + "), ("+ qArr[6] + ", " + qArr[7] + ") is not a quadrangle.\n");
						if(Geo.isQuadrangleC(qArr)) {
